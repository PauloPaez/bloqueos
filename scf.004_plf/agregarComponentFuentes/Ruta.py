...
# Diretorio Template
templateRuta = directorio_actual / "templates" / "ruta.txt"
...
code_import = []
code_import.append(f"import Listar{model_capitalized} from '../components/{model_capitalized}/Listar{model_capitalized}';\n")
