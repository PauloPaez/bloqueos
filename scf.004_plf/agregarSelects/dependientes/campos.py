...
def agregar_campo():
    ...
    if tipo == "select":
        # Para select, optionsKey es obligatorio y es el nombre en plural
        optionsKey = f"{nombre}s"  # Simple pluralización agregando 's'
        campo = {
            "name": nombre,
            "label": etiqueta,
            "type": tipo,
        ...
        # Si hay placeholder, lo agregamos como campo adicional
        if placeholder:
