...
campoSecundario = "departamento"
CampoSecundario = "departamento".capitalize()
campoPrimario = "provincia"
...
def valorizarPatron(arregloCodigo):
    ...
    "!moduloOwnerSecData!": moduloSecundario,
    "!ModuloOwnerSecData!": moduloSecundario.capitalize(),
    "!campoSecundario!" : campoSecundario,
    "!campoSecundarioPlural!": pluralizar(campoSecundario),
    "!CampoSecundarioPlural!": pluralizar(campoSecundario.capitalize()),
