export const formularioCampos = [
  ...
  {name: "padron", label: "Padrón", placeholder: "Padrón", type: "text", disabled: true},
  {name: "padron_dv", label: "DV Padrón", placeholder: "Digito verificador", type: "text", disabled: true},
  ...
  {name: "bloquear_todos_padrones_dni", label: "Bloquear todos los padrones correspondientes al DNI", placeholder: "no_visible", type: "checkbox"},
